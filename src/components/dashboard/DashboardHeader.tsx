...
export function DashboardHeader() {
  ...
  const currentDate = new Date().toLocaleDateString(t('landing.dashboard.locale'), {
    weekday: 'long',
    year: 'numeric',
    month: 'long',
    day: 'numeric'
  ...
  return (
    <div className="flex items-center justify-between mb-8">
      <div className="flex items-center space-x-4">
        <div>
          <h1 className="text-3xl font-black text-neutral-900 dark:text-white tracking-tight uppercase">{t('landing.dashboard.title')}</h1>
      ...
      <div className="flex items-center space-x-3">
        ...
        <Button variant="outline" size="sm" className="border-neutral-200 dark:border-stone-800 text-neutral-700 dark:text-stone-300 hover:bg-neutral-50 dark:hover:bg-stone-900 transition-colors">
          ...
          {t('landing.dashboard.notifications')}
        </Button>
        <AddMemberDialog />
      </div>
    </div>
