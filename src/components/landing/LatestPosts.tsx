...
export const LatestPosts = () => {
    ...
    return (
        <section className="py-32 bg-white dark:bg-neutral-950 overflow-hidden transition-colors duration-500">
                    ...
                    {loading ? (
                        [1, 2, 3].map((i) => (
                            <div key={i} className="space-y-6 animate-pulse">
                                <div className="h-80 bg-neutral-100 dark:bg-neutral-800 rounded-[2.5rem] w-full" />
                                <div className="space-y-3">
                                    <div className="h-4 bg-neutral-100 dark:bg-neutral-800 w-1/4 rounded" />
                                    <div className="h-8 bg-neutral-100 dark:bg-neutral-800 w-full rounded" />
                                    <div className="h-4 bg-neutral-100 dark:bg-neutral-800 w-3/4 rounded" />
                                </div>
                            </div>
                        ))
                    ) : (
                        posts.map((post, index) => (
                            ...
                            >
                                ...
                                <div className="space-y-4 px-2">
                                    ...
                                    <h3 className="text-2xl font-black text-neutral-900 dark:text-white leading-tight group-hover:text-brand-600 transition-colors">
                                        {post.title}
                                    </h3>
